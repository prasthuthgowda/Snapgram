...
export const useGetPosts = () => {
  return useInfiniteQuery({
    ...
    initialPageParam: null, // You can set an appropriate initial page param based on your API
  });
};
...
export const useLikePost = () => {
  ...
  return useMutation({
    mutationFn: ({ postId, likesArray }: { postId: string; likesArray: string[] }) => {
      if (!postId || !likesArray) {
        return Promise.reject(new Error("postId and likesArray are required"));
      }
